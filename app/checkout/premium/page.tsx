...
export default function PremiumCheckoutPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    deliveryTime: 'asap', // Default to ASAP for premium
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-32">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Premium Plan Checkout</h1>
          <p className="text-gray-600 mt-2">Complete your premium scooter lease setup</p>
        </div>
                          ...
                          <div className="flex items-center space-x-3 p-3 border-2 rounded-lg hover:bg-blue-50 border-blue-300 bg-blue-25">
                            ...
                            <Label htmlFor="asap" className="flex-1 cursor-pointer">
                              <div className="flex items-center justify-between">
                                ...
                                <span className="text-xs px-2 py-1 rounded bg-blue-500 text-white font-medium">PREMIUM CHOICE</span>
                              </div>
                            </Label>
                          </div>
