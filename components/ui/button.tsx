...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-sky-500 text-white shadow hover:bg-sky-600 focus:ring-sky-500",
        destructive: "bg-red-600 text-white shadow hover:bg-red-700 focus:ring-red-500",
        outline: "border border-gray-300 bg-white text-gray-700 shadow-sm hover:bg-gray-50 focus:ring-sky-500",
        secondary: "bg-gray-100 text-gray-900 shadow-sm hover:bg-gray-200 focus:ring-gray-500",
        ghost: "text-gray-700 hover:bg-gray-100 focus:ring-gray-500",
        link: "text-sky-600 underline-offset-4 hover:underline focus:ring-sky-500",
        cornell: "bg-cornell-red text-white shadow hover:bg-cornell-darkred focus:ring-cornell-red",
      },
      size: {
